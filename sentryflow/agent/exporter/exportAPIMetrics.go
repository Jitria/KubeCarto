...
type apiMetricStreamInform struct {
	...
	apiMetricsStream protobuf.Agent_GetAPIMetricsServer

	error chan error
}

// GetAPIMetrics Function (for gRPC)
func (exs *ExpService) GetAPIMetrics(info *protobuf.ClientInfo, stream protobuf.Agent_GetAPIMetricsServer) error {
