...
type envoyMetricsStreamInform struct {
	...
	metricsStream protobuf.Agent_GetEnvoyMetricsServer

	error chan error
}

// GetEnvoyMetrics Function (for gRPC)
func (exs *ExpService) GetEnvoyMetrics(info *protobuf.ClientInfo, stream protobuf.Agent_GetEnvoyMetricsServer) error {
